...
def check_mechanics(root,top,bottom,spacer,inlays,electronics,mounts,switches):
    ...
    result={'status':'CAD_CHECKS_PASSED_PHYSICAL_FIT_PENDING' if not(hits or deco_hits or screws) else 'FAILED',
      'case_outer_mm':[114.4,116,22.9],'pcb_thickness_mm':1.6,'electronics_solids_tested':len(electronics),
      ...
      'screw_tip_relief_clearance_mm':.75,'usb_socket_aperture_mm':[10.2,5.4],'usb_outer_recess_mm':[22,9],'usb_shell_setback_mm':1.06,
